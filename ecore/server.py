...
def serve(app, host="127.0.0.1", port="5000"):
    """
    ...
    parser.add_option("-H", "--host", help="Hostname of the Flask app [default %s]" % host,  default=host)
    parser.add_option("-P", "--port", help="Port for the Flask app [default %s]" % port, default=port)
